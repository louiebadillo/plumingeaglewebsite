        ...
        <div className="mb-12 sm:mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-1 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
            {coreComponents.map((component, index) => (
                              <div 
                  key={index}
                  className="flex flex-col items-start gap-3 p-3 sm:p-4 md:p-6 border-l-4 border-blue-500 bg-gray-50 dark:bg-gray-800 rounded-r-lg"
                >
                  <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 w-full">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-blue-500 rounded-full flex items-center justify-center text-white flex-shrink-0">
                      {component.icon}
                    </div>
