...
const Footer = () => {
  return (
    <footer className="bg-gray-300 dark:bg-gray-300 text-center text-lg-start text-muted pt-5 pb-10 px-10 relative">
      {/* Main Content Section */}
      <section className="">
        <div className="container mx-auto px-4 text-center mt-5">
          <div className="grid grid-cols-3 md:grid-cols-1 gap-8 mt-3 max-w-4xl mx-auto">

            {/* Programs Column */}
            <div className="mx-auto mb-4">
              <h6 className="text-uppercase font-bold mb-4 text-left">Our Programs</h6>
            ...
            {/* Useful Links Column */}
            <div className="mx-auto mb-4">
              <h6 className="text-uppercase font-bold mb-4 text-left">Useful Links</h6>
              <p className="mb-2 text-left text-sm">
            ...
            {/* Contact Column */}
            <div className="mx-auto mb-4">
              <h6 className="text-uppercase font-bold mb-4 text-left">Contact</h6>
              <p className="mb-2 flex items-center text-sm">
                <svg className="w-4 h-4 mr-3" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"/>
                </svg>
                23 Taralea Bay NE<br />
                Calgary, AB T3J 5H1
              </p>
              <p className="mb-2 flex items-center text-sm">
                <svg className="w-4 h-4 mr-3" fill="currentColor" viewBox="0 0 20 20">
              ...
              {/* Copyright Section */}
        <div className="text-center p-4 bg-gray-300 dark:bg-gray-300 w-full absolute bottom-0 left-0">
